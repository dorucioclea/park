...
import type { Row, InsertOrderItem } from "../../hooks/useOrderItems";

const fields: Array<keyof InsertOrderItem> = [
  "id",
  "order_id",
  "product_id",
  "quantity",
...
export default function CreateOrderItems({
  ...
  onCreate: (newRow: InsertOrderItem) => Promise<Row | undefined>;
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & InsertOrderItem;
    const newRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof InsertOrderItem, any>,
      );
    onCreate(newRow)
      .then((task) => {
        if (task) {
