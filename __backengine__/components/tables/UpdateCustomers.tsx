...
import type { Row, UpdateCustomer } from "../../hooks/useCustomers";

const fields: Array<keyof UpdateCustomer> = [
  "id",
  "name",
  "created_at",
  "updated_at",
...
export default function UpdateCustomers({
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateCustomer;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateCustomer, any>,
      );
