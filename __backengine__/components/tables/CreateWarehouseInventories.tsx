...
} from "../../hooks/useWarehouseInventories";

const fields: Array<keyof InsertWarehouseInventory> = [
  "id",
  "product_id",
  "quantity",
  "shelf_location",
...
export default function CreateWarehouseInventories({
  onCreate,
  onFetch,
}: {
  onCreate: (newRow: InsertWarehouseInventory) => Promise<Row | undefined>;
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const newRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof InsertWarehouseInventory, any>,
      );
    onCreate(newRow)
      .then((task) => {
        if (task) {
