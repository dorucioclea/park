...
import type { Row, UpdateOrderItem } from "../../hooks/useOrderItems";

const fields: Array<keyof UpdateOrderItem> = [
  "id",
  "order_id",
  "product_id",
  "quantity",
...
export default function UpdateOrderItems({
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateOrderItem;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateOrderItem, any>,
      );
