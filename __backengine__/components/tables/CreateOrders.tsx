...
import type { Row, InsertOrder } from "../../hooks/useOrders";

const fields: Array<keyof InsertOrder> = [
  "id",
  "order_date",
  "status",
  "customer_id",
...
export default function CreateOrders({
  ...
  onCreate: (newRow: InsertOrder) => Promise<Row | undefined>;
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & InsertOrder;
    const newRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof InsertOrder, any>,
      );
    onCreate(newRow)
      .then((task) => {
        if (task) {
