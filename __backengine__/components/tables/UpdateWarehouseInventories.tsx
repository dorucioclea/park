...
const fields: Array<keyof UpdateWarehouseInventory> = [
  "id",
  "product_id",
  "quantity",
  "shelf_location",
...
export default function UpdateWarehouseInventories({
  onUpdate,
  onFetch,
}: {
  onUpdate: (
    id: Row["id"],
    updatedRow: UpdateWarehouseInventory,
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateWarehouseInventory, any>,
      );
