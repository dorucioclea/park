...
import type { Row, UpdateProduct } from "../../hooks/useProducts";

const fields: Array<keyof UpdateProduct> = [
  "id",
  "product_id",
  "name",
  "price",
...
export default function UpdateProducts({
  ...
  const handleSubmit: FormEventHandler = (event) => {
    ...
    const target = event.target as typeof event.target & UpdateProduct;
    ...
    const updatedRow = fields
      ...
      .reduce(
        ...
        {} as Record<keyof UpdateProduct, any>,
      );
